...
<body>
	...
	<h1>Accommodation In Barcelona!</h1>
...
if ($result->num_rows > 0) {
    ...
    echo "<table><tr><th>SN</th><th>Accomodation Type</th><th>Name</th><th>Price</th><th>Ratings</th><th>Address</th><th>Url</th></tr>";
	//output data for each row
	while($row = $result->fetch_assoc()) {
		
		echo "<tr><td>". $row["Id"]. "</td><td>" . $row["Type"].  "</td><td>" . $row["Name"]." </td><td>" . $row["Price"]. "</td><td>". $row["Ratings"]. "</td><td>". $row["Location"]. "</td><td>". $row["Website"]. "</td><td>";
